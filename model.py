...
#alpha=0.1-->better performed than without hyperparameter
nb_model = BernoulliNB(alpha=0.1)
# save the model to disk
filename = 'nb_finalized_model.sav'
with open(filename, 'wb') as f:
    pickle.dump(nb_model, f)
#alpha=0.1-->better performed than alpha=0.001
...
#alpha=0.1-->better performed than hyperparameter=0.001
...
#from sklearn.cluster import MiniBatchKMeans
#reassignment_ratio=>0.001 is better and max_no of improvement is more
